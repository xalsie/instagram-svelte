<div class="animate-pulse rounded-xl bg-white">
	<div class="flex min-h-[220px] w-full items-center justify-center rounded-t-xl bg-neutral-200">
		<div class="h-[220px] w-full rounded-t-xl bg-neutral-200"></div>
	</div>
	<div class="p-3">
		<div class="flex items-center justify-between text-2xl">
			<div class="flex items-center gap-2">
				<div class="flex items-center">
					...
					<div class="ml-2.5">
						<div class="mb-1 h-4 w-20 rounded bg-neutral-200"></div>
						<div class="h-3 w-12 rounded bg-neutral-100"></div>
					</div>
				</div>
			</div>
			<div class="flex items-center justify-between gap-2">
				<div class="flex items-center">
					<svg
						...
						></path></svg
					>
					<div class="ml-1 h-3 w-5 rounded bg-neutral-200"></div>
				</div>
				<div class="flex items-center">
					<svg
						stroke="currentColor"
